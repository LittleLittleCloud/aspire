...
namespace Aspire.Hosting
{
    ...
    public static partial class ResourceBuilderExtensions
    {
        ...
        public static ApplicationModel.IResourceBuilder<T> WithHiddenOnCompletion<T>(this ApplicationModel.IResourceBuilder<T> builder, int exitCode = 0)
            where T : ApplicationModel.IResource { throw null; }
...
namespace Aspire.Hosting.ApplicationModel
{
    ...
    public sealed partial class EndpointReferenceAnnotation : IResourceAnnotation
    {
        ...
        public System.Collections.Generic.HashSet<string> EndpointNames { get { throw null; } }
